...
EVENTHUBS_NAMESPACE = "hospitalAnalyticsNamesapce.servicebus.windows.net"
EVENT_HUB_NAME="hospitalanalytics"  
CONNECTION_STRING = "Endpoint=sb://hospitalanalyticsnamesapce.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=eTVAm+WwSJpdV1TaXnLWpZgYfzyoCAx+2+AEhJAd7Lo="
